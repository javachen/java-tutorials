package com.javachen.boot.basic.validation.application;

import com.javachen.boot.basic.validation.controllers.UserController;
import com.javachen.boot.basic.validation.repositories.UserRepository;
